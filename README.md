...
Репозиторий с пайплайном резервного копирования и восстановления БД, а также запуском произвольного скрипта после разворачивания. Можно применять как для баз 1С, так и для любых баз MSSQL и PostgreSQL. Запуск скрипта позволяет деперсонифицировать данные, зная SQL-таблицы.

Репозиторий появился в рамках дополнительного занятия по курсу archdevops.ru. Видео демонстрирует работу пайплайна: ссылка на видео (https://vkvideo.ru/video-229431761_456239026).
...
## Если требуется автоматически создавать базу на кластере:
